...
Definir criterios mínimos de respaldo y recuperación para `database-consultorio`, de forma que el componente pueda restaurarse, estudiarse y demostrarse sin depender de memoria informal ni de una única instancia frágil.
...
### Esquema
La estructura de tablas, constraints, índices y catálogos del consultorio.
...
Debe existir una forma razonable de exportar y restaurar la base del consultorio.
...
Conviene mantener un estado base del consultorio que permita volver rápidamente a un entorno presentable.
...
- mezclar backups de farmacia con los del consultorio;
- usar datos sensibles reales como respaldo de práctica;
- trabajar migraciones riesgosas sin posibilidad de volver atrás.

## Resultado esperado

La estrategia de backup y recuperación debe darte seguridad mínima para estudiar, iterar y demostrar `database-consultorio` sin miedo a que un error de esquema o de datos te obligue a empezar desde cero cada vez.